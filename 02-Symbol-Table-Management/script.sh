...
rm -f y.tab.c y.tab.h y.output lex.yy.c y.o l.o a.out a.exe my_log.txt log.txt
...
echo "Step 6: Running against test file InputOutput/input1.c..."
./a.out InputOutput/input1.c

echo "Execution finished. Check my_log.txt for derivation and Symbol Table output."
